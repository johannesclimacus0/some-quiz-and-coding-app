    ...
    <AuthLayout title="Регистрация">
        <form class="flex flex-col gap-4" @submit.prevent="submit">
            ...
            <FormField id="password"
                       ...
                       required
            />
            <FormField id="password_confirmation"
                       ...
                       required
            />
            <SubmitButton :loading="loading" loading-text="Регистрация…">
                Зарегистрироваться
            </SubmitButton>
            <AlertMessage :message="generalError" />
        </form>
        <template #footer>
            <RouterLink :to="{ name: 'login' }" class="text-[#557789] transition-colors hover:text-[#287da8] dark:text-[#8ca8b7] dark:hover:text-[#65b7df]">
